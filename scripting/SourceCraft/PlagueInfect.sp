 ...
 */
public int Native_PlagueInfect(Handle plugin, int numParams)
{
 ...
 *                      const String:weapon_desc[]="");
 */
public int Native_ExplodePlayer(Handle plugin, int numParams)
{
 ...
 */
public int Native_HasPlayerExploded(Handle plugin, int numParams)
{
