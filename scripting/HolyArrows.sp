...
Handle v_Enabled = INVALID_HANDLE;
Handle v_Mode = INVALID_HANDLE;
Handle v_Flag = INVALID_HANDLE;
Handle v_HowHoly = INVALID_HANDLE;
Handle v_ArrowType = INVALID_HANDLE;
Handle v_Particle = INVALID_HANDLE;
