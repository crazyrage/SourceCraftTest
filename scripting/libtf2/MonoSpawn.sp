...
Handle Cvar_Eyeboss_AllowPublic = INVALID_HANDLE;
Handle Cvar_Eyeboss_Votesneeded = INVALID_HANDLE;
Handle Cvar_Eyeboss_VoteDelay = INVALID_HANDLE;

Handle v_BaseHP_Level2 = INVALID_HANDLE;
Handle v_HP_Per_Player = INVALID_HANDLE;
Handle v_HP_Per_Level = INVALID_HANDLE;
