...
public OnMapStart()
{
	...
	if (NavExist)
		LogMessage("Map %s has navigation", map);
	else
	{
	...
	WaypointsExist = FileExists(waypoints);
	if (WaypointsExist)
		LogMessage("Map %s has waypoints", map);
	else
	{
...
public OnClientPutInServer(client) 
{
	...
	{		
		Handle hTVName = FindConVar("tv_name"), String:sName[MAX_NAME_LENGTH], String:sTVName[MAX_NAME_LENGTH];
