		...
		switch(toggle)
		{
			case -1:
			{
				if(IsDrugged[target_list[i]])
				{
					...
					IsDrugged[target_list[i]] = 0;
					
				}else
				{
					ClientCommand(target_list[i], "r_screenoverlay effects/tp_eyefx/tp_eyefx.vmt");
					IsDrugged[target_list[i]] = 1;
				}
			}
			case 0:
			{
				ClientCommand(target_list[i], "r_screenoverlay 0");
				IsDrugged[target_list[i]] = toggle;
			}
			case 1:
			{
				ClientCommand(target_list[i], "r_screenoverlay effects/tp_eyefx/tp_eyefx.vmt");
			...
			case 2:
			{
				ClientCommand(target_list[i], "r_screenoverlay effects/tp_eyefx/tp_eyefx_eli.vmt");
				IsDrugged[target_list[i]] = toggle;
			}
			case 3:
			{
				ClientCommand(target_list[i], "r_screenoverlay effects/tp_eyefx/tpeye.vmt");
				IsDrugged[target_list[i]] = toggle;
			}
			case 4:
			{
				ClientCommand(target_list[i], "r_screenoverlay effects/tp_eyefx/tpeye2.vmt");
				IsDrugged[target_list[i]] = toggle;
			}
			case 5:
			{
				ClientCommand(target_list[i], "r_screenoverlay effects/tp_eyefx/tpeye3.vmt");
				IsDrugged[target_list[i]] = toggle;
			}
			case 6:
			{
				ClientCommand(target_list[i], "r_screenoverlay effects/tp_eyefx/tpblack.vmt");
				IsDrugged[target_list[i]] = toggle;
			}
			case 7:
			{
				ClientCommand(target_list[i], "r_screenoverlay debug/yuv.vmt");
				IsDrugged[target_list[i]] = toggle;
			}
			case 8:
			{
				ClientCommand(target_list[i], "r_screenoverlay effects/com_shield002a.vmt");
				IsDrugged[target_list[i]] = toggle;
			}
			case 9:
			{
				ClientCommand(target_list[i], "r_screenoverlay models/effects/portalfunnel_sheet.vmt");
				IsDrugged[target_list[i]] = toggle;
			}
			case 10:
			{
				ClientCommand(target_list[i], "r_screenoverlay models/props_combine/portalball001_sheet.vmt");
				IsDrugged[target_list[i]] = toggle;
			}
			case 11:
			{
				ClientCommand(target_list[i], "r_screenoverlay effects/screenwarp.vmt");
				IsDrugged[target_list[i]] = toggle;
			}
			case 12:
			{
				ClientCommand(target_list[i], "r_screenoverlay effects/strider_bulge_dudv.vmt");
				IsDrugged[target_list[i]] = toggle;
			}
		}
	}
